...
>  "Representar a realidade em um modelo conceitual depende de nossa percepção do mundo." — Prof. Palazzo

---

## 1. O Processo de Modelagem: Da Percepção ao Modelo
...
- A modelagem de sistemas falha frequentemente por problemas de percepção e alinhamento entre as partes envolvidas.
- Não basta criar uma estrutura formal; é preciso validar constantemente se o modelo reflete a realidade imaginada pelo usuário.
- Decisões estratégicas de alto nível não podem ser totalmente automatizadas, pois exigem conhecimento externo e sensibilidade humana.
