...
-  [02:22-03:35](https://www.youtube.com/watch?v=undefined&t=142s) **O início nos anos 60:** a era dos fluxogramas manuais, bancos de dados hierárquicos e programação em Cobol.
- [06:42-08:18] O modelo hierárquico (ex: IMS/DB): estrutura em árvore onde a navegação era explícita e qualquer mudança física exigia reprogramação das aplicações.
...
- [08:19-10:27] O surgimento do modelo relacional (Codd, 1970): foco no "o que fazer" e não "como fazer" (SQL), trazendo independência física.
- [10:31-16:15] Normalização (Formas Normais): o processo de remover redundâncias e garantir que o modelo reflita dependências funcionais, evitando anomalias de atualização.
- [17:28-18:41] O modelo Entidade-Relacionamento (Peter Chen, 1976): a formalização que permitiu uma representação visual clara e validável com os usuários do sistema.
...
- [21:00-23:15] Bancos de dados orientados a objetos: surgiram para superar as limitações da primeira forma normal, permitindo representar mapas, imagens e estruturas espaciais.
- [23:23-24:55] O modelo UML: uma tentativa de unificar a especificação de sistemas, embora ainda carecesse de uma base semântica única.
- [25:00-27:29] Ontologias: a fronteira atual onde o modelo de dados representa conceitos, propriedades e relacionamentos, permitindo inferências lógicas sobre o domínio.
