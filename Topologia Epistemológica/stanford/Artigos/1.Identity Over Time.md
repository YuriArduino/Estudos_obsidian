...
>>The problem of [[Identidade através do tempo|identity through time]] can be introduced by noting that the following two statements both seem true but, on the assumption that [[Mudança (Filosofia)|change]] is real, appear to be inconsistent:
