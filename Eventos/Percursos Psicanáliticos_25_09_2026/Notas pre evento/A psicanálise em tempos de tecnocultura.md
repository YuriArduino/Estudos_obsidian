Com base no artigo de Alessandra Lemma, _"A psicanálise em tempos de tecnocultura: algumas reflexões sobre o destino do corpo no espaço virtual"_
...
- Manejo Clínico Maleável: O analista precisa desenvolver um "setting interno" flexível, abandonando visões distópicas ou julgamentos morais simples sobre o uso que o paciente faz das redes digitais.
- O Virtual como Desenvolvimento: O ciberespaço pode funcionar como um "espaço transicional" saudável. No caso clínico do paciente B, o ambiente virtual serviu como um ensaio seguro (um _embodiment imaginado_) que legitimou sua sexualidade e sua imagem corporal antes que ele conseguisse transferir isso para relações reais e para a própria transferência com a analista.
- Identificação de Defesas: Ajuda o clínico a diferenciar quando o paciente usa a tecnologia para criar novas pontes criativas de expressão ou quando a usa como um _acting out_ compulsivo (como a pornografia na internet) para suspender a sua história e fugir das dores do mundo físico.
...
Ao abordar a virtualização real no texto em questão, a autora foca no corpo, uma espécie de dialética entre **incorporar** e **desincorporar** ([Embodiment] vs. [Disembodied]). Além disso, o conceito de [Mediação] é levantado como o ponto de encontro entre tais camadas, perpassando os campos do **superficial** e do **íntimo**.
...
> ([[A psicanálise em tempos de tecnocultura.pdf#page=4&selection=10,25,18,6&color=yellow|p.4]])
> a psicanálise – que se baseia na tensão humana fundamental entre a atração exercida pelo “princípio do prazer” e a frustração colocada pelo “princípio da realidade” (Freud, 1920/1966) –, o virtual é para o real o que a cópia é para o original: uma reprodução que permite que os desejos colonizem a realidade. 

> ([[A psicanálise em tempos de tecnocultura.pdf#page=4&selection=29,18,36,39&color=yellow|p.4]])
> natureza virtual do próprio real, na medida em que este é filtrado através de um universo de relações objetais – universo este que é distorcido pelos processos projetivos e introjetivos – que cria outros virtuais, os quais trazem em si ressonâncias emocionais e nos comunicam como vivenciamos o mundo e nele agimos.

> ([[A psicanálise em tempos de tecnocultura.pdf#page=4&annotation=94R|p.4]])
...
Não começou bem o capítulo "O destino do corpo no ciberespaço", a etimologia citada tem de ser conferida, e seu uso para justificar a necessidade de controle realizada do cyberespaço resultando em um espaço controlado. O artigo é de 2015 e considero interessante checar as publicações atuais da autora. Quase 11 anos depois e se realiza uma fuzão a lá biopoder foulcoutiano algorítimico ou a antropotécnica de Sloterdijk, a relação de depêndencia desaparece, pois se realiza a simbiose ou o aperfeiçoamento. Existe controle na medida em que aceitamos o controle, seja da rotinas, do corpo, saúde e do tempo. Talvez até algo além do "virtualmente real".  Para não ter duvida quanto ao anacrônismo a autora mesmo cita na 
...
Sobre a questão do isomorfismo já discordo totalmente, para ocorrer o isomorfismo, seria preciso abandonar todas as camadas que a autora mesmo citou anteriormente, até mesmo a mediação. Eu ainda insisto na relação simbiótica em que ambos compartilham o mesmo referêncial. Concordo caso a relação isomórfica se torne como citado um delírio onipotente. 
...
> ([[A psicanálise em tempos de tecnocultura.pdf#page=9&selection=71,0,89,29&color=red|p.9]])
> No ciberespaço, a sensação de velocidade e disponibilidade imediata substitui a realidade de um outro real, que nunca pode estar plenamente disponível ao self ou ser por ele controlado. Sabemos que um dos principais desafios da sexualidade é que a alteridade se encontra em seu centro. Essa alteridade precisa ser integrada na experiência subjetiva da sexualidade. Todos os desejos se concentram em um outro e, mais especificamente, a existência do outro nos confronta tanto com nossa dependência quanto com nossa passividade – posições que mobilizam ansiedade. Isso funciona de modo diferente em vários níveis do ciberespaço.
